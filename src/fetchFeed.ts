...
export async function fetchFeed(feedURL:string){
    ...
    const channel_title:string = channel.title;
    const channel_link:string = channel.link;
    const channel_description: string = channel.description;
    ...
    let channel_items = new Array<{title:string, link:string, description:string}>;
